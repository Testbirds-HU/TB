...
-->
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="text-centered">Mészár Anna</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9 col-md-pull-3">
							<h2 class="text-centered">Bartha Gizella</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="text-centered">Makkai Bianka</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9 col-md-pull-3">
							<h2 class="text-centered">Horváth László</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="text-centered">Muszka Ágnes</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9 col-md-pull-3">
							<h2 class="text-centered">Vászon Gergely</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="text-centered">Csankovszki Kata</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9 col-md-pull-3">
							<h2 class="text-centered">Lichter Tamás</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9">
							<h2 class="text-centered">Maczinkó Ákos</h2>
							<span>
								<p>
					...
					<div class="row">
						...
						<div class="col-md-9 col-md-pull-3">
							<h2 class="text-centered">Bertényi Barnabás</h2>
							<span>
								<p>
