...
-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"> <b class="text-centered">Maczinkó Ákos</b>
                                <div>
                                    <p> 15+ év tapasztalat a telekommunikáció világában, elsősorban értékesítési és ügyfélélmény területen. Éveken keresztül részt vett lakossági termékek kialakításában és kereskedelmi elindításában. Ákos Tamással együtt vezeti a közép-európai Testbirds-öt, ami most már három országban működik. </p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"> <b class="text-centered">Bertényi Barnabás</b>
                                <div>
                                    <p> Barnabás pályáját crowdtesztelőként kezdte és körülbelül aznap csatlakozott a Testbirds-höz, amint az legálisan lehetséges volt, alighogy a tizennyolcat betöltötte, az érettségi vizsgák után egyből az irodába jött dolgozni – vagyis ha valakire igaz, hogy lelkes fiatal, az Barnabás. </p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Csankovszki Kata</b>
                                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"> <b class="text-centered">Horváth László</b>
                                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Makkai Bianka</b>
                                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"> <b class="text-centered">Mészár Anna</b>
                                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Muszka Ágnes</b>
                                <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9"> <b class="text-centered">Vászon Gergely</b>
                                <div>
