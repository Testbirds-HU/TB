    ...
    <div id="pagewrap">
      ...
      <div class="container">
        ...
        <div class="csatlakozz">
          <div class="row">
            <p><?=writeText($lang,'fooldal_legytesztelo',$content);?><a href="//nest.testbirds.com" target="_blank" class="pageload-link">&nbsp;<?=writeText($lang,'fooldal_legytesztelo2',$content);?></a></p>
          </div>
        </div>
