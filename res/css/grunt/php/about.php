...
-->
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Lichter Tamás</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Maczinkó Ákos</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Bartha Gizella</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Bertényi Barnabás</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Csankovszki Kata</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Horváth László</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Makkai Bianka</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Mészár Anna</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Muszka Ágnes</b> <div>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Vászon Gergely</b> <div>
								<p>
