...
-->
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Lichter Tamás</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Maczinkó Ákos</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Bartha Gizella</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Bertényi Barnabás</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Csankovszki Kata</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Horváth László</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Makkai Bianka</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Mészár Anna</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-md-pull-3"> <b class="text-centered">Muszka Ágnes</b> <span>
								<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9"> <b class="text-centered">Vászon Gergely</b> <span>
								<p>
